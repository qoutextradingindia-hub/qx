...
const Dashboard = () => {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(`https://startradersindia.in/api/admin/user/${user._id}`)
      .then(res => {
    ...
    // Referral Income
    axios
      .get(`https://startradersindia.in/api/user/referral-income/${user._id}`)
      .then(res => {
  ...
  const referralLink = referralCode ? `https://startradersindia.in/register?ref=${referralCode}` : '';
