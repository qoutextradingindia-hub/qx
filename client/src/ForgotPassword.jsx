...
const ForgotPassword = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post('https://startradersindia.in/api/user/send-forgot-otp', { email });
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post('https://startradersindia.in/api/user/verify-forgot-otp', { email, otp });
